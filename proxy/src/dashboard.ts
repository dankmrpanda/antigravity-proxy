...
function readEnv(): Record<string, string> {
  ...
  const KNOWN_ENV_KEYS = [
    ...
    'OPENCODE_API_KEY', 'OPENCODE_GO_API_KEY', 'MODEL_API_KEY', 'META_BASE_URL', 'CONTEXT_STRIP_MODE',
